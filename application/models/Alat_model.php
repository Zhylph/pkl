...
class Alat_model extends CI_Model
{
    ...
    {
        return $this->db->get_where($this->_table, ["id_alat" => $id_alat])->row();
    }
    ...
    public function update()
    {
        ...
        $this->nama_alat    = $post["nama_alat"];
        $this->biaya        = $post["biaya"];
        $this->db->update($this->_table, $this, array('id_alat' => $post['id_alat']));
    }

    public function delete($id_alat)
    {
        return $this->db->delete($this->_table, array("id_alat" => $id_alat));
    }
