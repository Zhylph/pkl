            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('data/addpanitia'); ?>" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="nama_panitia" placeholder="Nama panita...">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="anggaran" class="col-sm-3 col-form-label">Tugas Panitia</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="tugas" placeholder="Tugas panitia... ">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="anggaran" class="col-sm-3 col-form-label">Gaji Panitia</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="gaji" placeholder="Rp. ">
                                    </div>
                                </div>
                                <div class="class row">
                                    <div class="col-sm-10">
