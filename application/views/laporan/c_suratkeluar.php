...
<html><head>
    ...
    <h6 class="status">Laporan Surat Keluar</i></h6>
    <table width="100%" border="1" class="center">
        ...
        foreach ($surat as $s) : ?>
            ...
            <tr>
                ...
                <td align="center"><?= date('d F Y', strtotime($s['tgl_surat'])); ?></td>
                <td align="center"><?= $s['perihal']; ?></td>
                <td align="center"><?= $s['nama_pegawai']; ?></td>
            </tr>
