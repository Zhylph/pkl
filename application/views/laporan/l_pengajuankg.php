    ...
    <table width="100%" border="1" class="center">
        ...
        foreach ($pengajuan as $p) : ?>
            ...
            <tr>
                ...
                <td align="center"><?= $p['tanggal_pengajuan']; ?></td>
                <td align="center">Rp. <?php echo number_format ($p['gaji_lama'], 2); ?></td>
                <td align="center"><?= date('d F Y', strtotime($p['tanggal_verif'])); ?></td>
                <td align="center">Rp. <?php echo number_format ($p['gaji_baru'], 2); ?></td>
            </tr>
