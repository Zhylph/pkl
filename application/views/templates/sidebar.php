    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            <div class="sidebar-brand-icon">
                <img src='' alt="" width="80%" class="img img-responsive">
            </div>
            <div class="sidebar-brand-text text-warning mx-3">DISPORBUDPAR </div>
        ...
        <?php foreach ($menu as $m) : ?>
            <div class="sidebar-heading text text-warning">
                <?= $m['menu']; ?>
            </div>
            ...
            <?php foreach ($subMenu as $sm) : ?>
                ...
                <?php if ($title == $sm['title']) : ?>
                    ...
                    <a class="nav-link pb-0 text text-warning" href="<?= base_url($sm['url']); ?>">
                        <i class="<?= $sm['icon']; ?>"></i>
            ...
            <li class="nav-item">
                <a class="nav-link text text-warning" href="<?= base_url('auth/logout') ?>">
