                            ...
                            <?php foreach ($pengajuan as $b) : ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="<?= base_url(); ?>data/accpengajuan_p/<?= $b['id_pengajuan']; ?>/<?= $b['nip']; ?>/<?= $b['jenis_pengajuan']; ?>/<?= $b['id_jenis_pengajuan']; ?>" class="btn btn-success btn-sm"><i class="fas fa-solid fa-check"></i> </a>
                                        <a href="" data-toggle="modal" data-target="#tolak-data" class="btn btn-danger btn-sm"><i class="fas fa-solid fa-ban"></i> </a>
                                        <a href="<?php echo base_url('data/approve3/' . $b['id_pengajuan']) ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tolak-data" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?= base_url('data/tolakpengajuan_p') ?>" method="post" enctype="multipart/form-data" role="form">
