                        ...
                        <tbody>
                            ...
                            <?php foreach ($pengajuan as $b) : ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?php echo base_url('data/cetak_kp/' . $b['nip']) ?>" class="btn btn-primary btn-sm"><i class="fas fa-print"></i></a>
                                        ...
                                        <a href="<?php echo base_url('data/approve1/' . $b['id_pengajuan']) ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Input Golongan Baru</h4>
                        <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                    </div>
                    <form class="form-horizontal" action="<?= base_url('data/terimapengajuan_kp') ?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="col-lg-112">
                                    ...
                                    <input type="hidden" id="golongan_lama" name="golongan_lama" value="<?= $b['golongan']; ?>">
                                    <input type="text" class="form-control" id="golongan" name="golongan" placeholder="Golongan Baru....">
                                </div>
                            </div>
                        </div>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tolak-data" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?= base_url('data/tolakpengajuan') ?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="col-lg-112">
                                    <input type="hidden" id="id" name="id" value="<?= $b['id_pengajuan']; ?>">
